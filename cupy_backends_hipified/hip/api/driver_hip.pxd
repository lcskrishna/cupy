...
IF CUPY_USE_CUDA_PYTHON:
    ...
    ctypedef hipDevice_t Device
    ctypedef hipError_t Result
    ctypedef hipCtx_t Context
    ctypedef hipDeviceptr_t Deviceptr
    ctypedef hipEvent_t Event
    ctypedef hipFunction_t Function
    ctypedef hipModule_t Module
    ctypedef hipStream_t Stream
    ctypedef CUlinkState LinkState
    ctypedef hipArray* Array
    ctypedef hipArray_format Array_format
    ctypedef HIP_ARRAY_DESCRIPTOR Array_desc
    ctypedef hipAddress_mode Address_mode
    ctypedef hipTextureFilterMode Filter_mode
ELSE:
