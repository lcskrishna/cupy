...
IF CUPY_USE_CUDA_PYTHON:
    ...
    ctypedef hipError_t Error
    ctypedef hipDataType_t DataType

    ctypedef hipDeviceAttribute_t DeviceAttr
    ctypedef hipMemoryAdvise MemoryAdvise

    ctypedef hipStreamCallback_t StreamCallback
    ctypedef cudaHostFn_t HostFn

    ctypedef hipChannelFormatKind ChannelFormatKind
    ctypedef hipChannelFormatDesc ChannelFormatDesc
    ctypedef hipTextureObject_t TextureObject
    ctypedef cudaSurfaceObject_t SurfaceObject
    ctypedef hipResourceType ResourceType
    ctypedef hipTextureAddressMode TextureAddressMode
    ctypedef hipTextureFilterMode TextureFilterMode
    ctypedef hipTextureReadMode TextureReadMode
    ctypedef hipResourceViewDesc ResourceViewDesc
    ctypedef hipArray_t Array
    ctypedef hipExtent Extent
    ctypedef hipPos Pos
    ctypedef hipPitchedPtr PitchedPtr
    ctypedef hipMemcpyKind MemoryKind
    ctypedef hipMipmappedArray_t MipmappedArray

    ctypedef hipLimit_t Limit

    ctypedef hipResourceDesc ResourceDesc

    ctypedef hipMemcpy3DParms Memcpy3DParms

    ctypedef hipTextureDesc TextureDesc

    ctypedef hipIpcMemHandle_t IpcMemHandle

    ctypedef hipIpcEventHandle_t IpcEventHandle
    ...
    ctypedef hipPointerAttribute_t _PointerAttributes

    ctypedef hipDeviceProp_t DeviceProp

    ctypedef hipStreamCaptureStatus StreamCaptureStatus
    ctypedef hipStreamCaptureMode StreamCaptureMode
    ctypedef hipGraph_t Graph
    ctypedef hipGraphExec_t GraphExec
...
# TODO(leofang): add hipGetSurfaceObjectResourceDesc
