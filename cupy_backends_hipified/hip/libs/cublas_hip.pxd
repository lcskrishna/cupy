...
cdef extern from *:
    ctypedef void* cuComplexPtr 'rocblas_float_complex*'
    ctypedef void* cuDoubleComplexPtr 'rocblas_double_complex*'


cdef extern from *:
    ctypedef void* Handle 'rocblas_handle'

    ctypedef int DiagType 'rocblas_diagonal'
    ctypedef int FillMode 'rocblas_fill'
    ctypedef int Operation 'rocblas_operation'
    ctypedef int PointerMode 'rocblas_pointer_mode'
...
cpdef enum:
    ...
    rocblas_side_left = 0
    rocblas_side_right = 1

    rocblas_fill_lower = 0
    rocblas_fill_upper = 1

    rocblas_diagonal_non_unit = 0
    rocblas_diagonal_unit = 1
