...
cdef extern from '../../cupy_sparse.h' nogil:
    ...
    # Version
    hipsparseStatus_t cusparseGetVersion(hipsparseHandle_t handle, int* version)

    # cuSPARSE Helper Function
    Status hipsparseCreate(Handle *handle)
    Status hipsparseCreateMatDescr(MatDescr descr)
    Status hipsparseDestroy(Handle handle)
    Status hipsparseDestroyMatDescr(MatDescr descr)
    Status hipsparseSetMatIndexBase(MatDescr descr, IndexBase base)
    Status hipsparseSetMatType(MatDescr descr, MatrixType type)
    Status hipsparseSetMatFillMode(MatDescr descrA, FillMode fillMode)
    Status hipsparseSetMatDiagType(MatDescr descrA, DiagType diagType)
    Status hipsparseSetPointerMode(Handle handle, PointerMode mode)

    # Stream
    Status hipsparseSetStream(Handle handle, Stream streamId)
    ...
    Status cusparseCgthr(
        Handle handle, int nnz, const rocblas_float_complex *y, rocblas_float_complex *xVal,
        const int *xInd,
        IndexBase idxBase)

    Status cusparseZgthr(
        Handle handle, int nnz, const rocblas_double_complex *y,
        rocblas_double_complex *xVal, const int *xInd,
        IndexBase idxBase)
    ...
    Status cusparseCcsrmv(
        Handle handle, Operation transA, int m, int n, int nnz,
        const rocblas_float_complex *alpha, MatDescr descrA,
        const rocblas_float_complex *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        const rocblas_float_complex *x, const rocblas_float_complex *beta, rocblas_float_complex *y)

    Status cusparseZcsrmv(
        Handle handle, Operation transA, int m, int n, int nnz,
        const rocblas_double_complex *alpha, MatDescr descrA,
        const rocblas_double_complex *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        const rocblas_double_complex *x, const rocblas_double_complex *beta,
    ...
    Status cusparseCcsrsv2_bufferSize(
        Handle handle, Operation transA, int m, int nnz, const MatDescr descrA,
        rocblas_float_complex* csrSortedValA, const int* csrSortedRowPtrA,
        const int* csrSortedColIndA, csrsv2Info_t info,
        int* pBufferSizeInBytes)
    Status cusparseZcsrsv2_bufferSize(
        Handle handle, Operation transA, int m, int nnz, const MatDescr descrA,
        rocblas_double_complex* csrSortedValA, const int* csrSortedRowPtrA,
        const int* csrSortedColIndA, csrsv2Info_t info,
        int* pBufferSizeInBytes)
    ...
    Status cusparseCcsrsv2_analysis(
        Handle handle, Operation transA, int m, int nnz, const MatDescr descrA,
        const rocblas_float_complex* csrSortedValA, const int* csrSortedRowPtrA,
        const int* csrSortedColIndA, csrsv2Info_t info,
        hipsparseSolvePolicy_t policy, void* pBuffer)
    Status cusparseZcsrsv2_analysis(
        Handle handle, Operation transA, int m, int nnz, const MatDescr descrA,
        const rocblas_double_complex* csrSortedValA, const int* csrSortedRowPtrA,
        const int* csrSortedColIndA, csrsv2Info_t info,
        hipsparseSolvePolicy_t policy, void* pBuffer)
    ...
    Status cusparseCcsrsv2_solve(
        Handle handle, Operation transA, int m, int nnz,
        const rocblas_float_complex* alpha, const MatDescr descrA,
        const rocblas_float_complex* csrSortedValA, const int* csrSortedRowPtrA,
        const int* csrSortedColIndA, csrsv2Info_t info,
        const rocblas_float_complex* x, rocblas_float_complex* y,
        hipsparseSolvePolicy_t policy, void* pBuffer)
    Status cusparseZcsrsv2_solve(
        Handle handle, Operation transA, int m, int nnz,
        const rocblas_double_complex* alpha, const MatDescr descrA,
        const rocblas_double_complex* csrSortedValA, const int* csrSortedRowPtrA,
        const int* csrSortedColIndA, csrsv2Info_t info,
        const rocblas_double_complex* x, rocblas_double_complex* y,
        hipsparseSolvePolicy_t policy, void* pBuffer)
    ...
    Status cusparseCcsrmm(
        ...
        const rocblas_float_complex *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        const rocblas_float_complex *B, int ldb, const rocblas_float_complex *beta,
    ...
    Status cusparseZcsrmm(
        ...
        const rocblas_double_complex *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        const rocblas_double_complex *B, int ldb,
        const rocblas_double_complex *beta, rocblas_double_complex *C, int ldc)

    Status hipsparseScsrmm2(
    ...
    Status hipsparseDcsrmm2(
        Handle handle, Operation transA, Operation transB, int m, int n, int k,
        int nnz, const double *alpha, const MatDescr descrA,
        const double *csrValA, const int *csrRowPtrA, const int *csrColIndA,
        const double *B, int ldb, const double *beta, double *C, int ldc)

    Status hipsparseCcsrmm2(
        Handle handle, Operation transA, Operation transB, int m, int n, int k,
        int nnz, const rocblas_float_complex *alpha, const MatDescr descrA,
        const rocblas_float_complex *csrValA, const int *csrRowPtrA, const int *csrColIndA,
        const rocblas_float_complex *B, int ldb, const rocblas_float_complex *beta,
        rocblas_float_complex *C, int ldc)

    Status hipsparseZcsrmm2(
        Handle handle, Operation transA, Operation transB, int m, int n, int k,
        int nnz, const rocblas_double_complex *alpha, const MatDescr descrA,
        const rocblas_double_complex *csrValA,
        const int *csrRowPtrA, const int *csrColIndA,
        const rocblas_double_complex *B, int ldb, const rocblas_double_complex *beta,
    ...
    Status cusparseScsrsm2_bufferSizeExt(
        ...
        int ldb, csrsm2Info_t info, hipsparseSolvePolicy_t policy,
        size_t* pBufferSize)
    ...
    Status cusparseCcsrsm2_bufferSizeExt(
        Handle handle, int algo, Operation transA, Operation transB, int m,
        int nrhs, int nnz, const rocblas_float_complex* alpha, const MatDescr descrA,
        const rocblas_float_complex* csrSortedValA, const int* csrSortedRowPtrA,
        const int* csrSortedColIndA, const rocblas_float_complex* B,
        int ldb, csrsm2Info_t info, hipsparseSolvePolicy_t policy,
        size_t* pBufferSize)
    Status cusparseZcsrsm2_bufferSizeExt(
        Handle handle, int algo, Operation transA, Operation transB, int m,
        int nrhs, int nnz, const rocblas_double_complex* alpha, const MatDescr descrA,
        const rocblas_double_complex* csrSortedValA, const int* csrSortedRowPtrA,
        const int* csrSortedColIndA, const rocblas_double_complex* B,
        int ldb, csrsm2Info_t info, hipsparseSolvePolicy_t policy,
        size_t* pBufferSize)
    ...
    Status cusparseCcsrsm2_solve(
        ...
        int nrhs, int nnz, const rocblas_float_complex* alpha, const MatDescr descrA,
        const rocblas_float_complex* csrSortedValA, const int* csrSortedRowPtrA,
        const int* csrSortedColIndA, rocblas_float_complex* B,
        int ldb, csrsm2Info_t info, hipsparseSolvePolicy_t policy,
        void* pBuffer)
    Status cusparseZcsrsm2_solve(
        ...
        int nrhs, int nnz, const rocblas_double_complex* alpha, const MatDescr descrA,
        const rocblas_double_complex* csrSortedValA, const int* csrSortedRowPtrA,
        const int* csrSortedColIndA, rocblas_double_complex* B,
        int ldb, csrsm2Info_t info, hipsparseSolvePolicy_t policy,
        void* pBuffer)
    ...
    Status cusparseCcsrgeam(
        Handle handle, int m, int n, const rocblas_float_complex *alpha,
        const MatDescr descrA,
        int nnzA, const rocblas_float_complex *csrValA, const int *csrRowPtrA,
        const int *csrColIndA, const rocblas_float_complex *beta, const MatDescr descrB,
        int nnzB, const rocblas_float_complex *csrValB, const int *csrRowPtrB,
        const int *csrColIndB, const MatDescr descrC, rocblas_float_complex *csrValC,
        int *csrRowPtrC, int *csrColIndC)

    Status cusparseZcsrgeam(
        Handle handle, int m, int n, const rocblas_double_complex *alpha,
        const MatDescr descrA,
        int nnzA, const rocblas_double_complex *csrValA, const int *csrRowPtrA,
        const int *csrColIndA, const rocblas_double_complex *beta,
        const MatDescr descrB,
        int nnzB, const rocblas_double_complex *csrValB, const int *csrRowPtrB,
        const int *csrColIndB, const MatDescr descrC,
        rocblas_double_complex *csrValC, int *csrRowPtrC, int *csrColIndC)

    Status hipsparseScsrgeam2_bufferSizeExt(
        Handle handle, int m, int n, const float *alpha, const MatDescr descrA,
        int nnzA, const float *csrValA, const int *csrRowPtrA,
        const int *csrColIndA, const float *beta, const MatDescr descrB,
        int nnzB, const float *csrValB, const int *csrRowPtrB,
    ...
    Status hipsparseDcsrgeam2_bufferSizeExt(
        Handle handle, int m, int n, const double *alpha,
        const MatDescr descrA,
        int nnzA, const double *csrValA, const int *csrRowPtrA,
        const int *csrColIndA, const double *beta, const MatDescr descrB,
    ...
    Status hipsparseCcsrgeam2_bufferSizeExt(
        Handle handle, int m, int n, const rocblas_float_complex *alpha,
        const MatDescr descrA,
        int nnzA, const rocblas_float_complex *csrValA, const int *csrRowPtrA,
        const int *csrColIndA, const rocblas_float_complex *beta, const MatDescr descrB,
    ...
    Status hipsparseZcsrgeam2_bufferSizeExt(
        Handle handle, int m, int n, const rocblas_double_complex *alpha,
        const MatDescr descrA,
        int nnzA, const rocblas_double_complex *csrValA, const int *csrRowPtrA,
        const int *csrColIndA, const rocblas_double_complex *beta,
    ...
    Status cusparseCcsrgemm(
        Handle handle, Operation transA, Operation transB, int m, int n, int k,
        const MatDescr descrA, const int nnzA, const rocblas_float_complex *csrValA,
        const int *csrRowPtrA, const int *csrColIndA, const MatDescr descrB,
        const int nnzB, const rocblas_float_complex *csrValB, const int *csrRowPtrB,
        const int *csrColIndB, const MatDescr descrC, rocblas_float_complex *csrValC,
        const int *csrRowPtrC, int *csrColIndC)

    Status cusparseZcsrgemm(
        Handle handle, Operation transA, Operation transB, int m, int n, int k,
        const MatDescr descrA, const int nnzA, const rocblas_double_complex *csrValA,
        const int *csrRowPtrA, const int *csrColIndA, const MatDescr descrB,
        const int nnzB, const rocblas_double_complex *csrValB, const int *csrRowPtrB,
        const int *csrColIndB, const MatDescr descrC, rocblas_double_complex *csrValC,
        const int *csrRowPtrC, int *csrColIndC)
    ...
    Status hipsparseScsrgemm2_bufferSizeExt(
    ...
    Status hipsparseDcsrgemm2_bufferSizeExt(
    ...
    Status cusparseCcsrgemm2_bufferSizeExt(
        Handle handle, int m, int n, int k, const rocblas_float_complex *alpha,
        const MatDescr descrA, int nnzA, const int *csrRowPtrA,
        const int *csrColIndA, const MatDescr descrB, int nnzB,
        const int *csrRowPtrB, const int *csrColIndB, const rocblas_float_complex *beta,
        const MatDescr descrD, int nnzD, const int *csrRowPtrD,
        const int *csrColIndD, const csrgemm2Info_t info, size_t* pBufferSize)

    Status cusparseZcsrgemm2_bufferSizeExt(
        Handle handle, int m, int n, int k, const rocblas_double_complex *alpha,
        const MatDescr descrA, int nnzA, const int *csrRowPtrA,
        const int *csrColIndA, const MatDescr descrB, int nnzB,
        const int *csrRowPtrB, const int *csrColIndB,
        const rocblas_double_complex *beta, const MatDescr descrD, int nnzD,
        const int *csrRowPtrD, const int *csrColIndD,
        const csrgemm2Info_t info, size_t* pBufferSize)

    Status hipsparseXcsrgemm2Nnz(
    ...
    Status cusparseCcsrgemm2(
        Handle handle, int m, int n, int k, const rocblas_float_complex *alpha,
        const MatDescr descrA, int nnzA, const rocblas_float_complex *csrValA,
        const int *csrRowPtrA, const int *csrColIndA, const MatDescr descrB,
        int nnzB, const rocblas_float_complex *csrValB, const int *csrRowPtrB,
        const int *csrColIndB, const rocblas_float_complex *beta, const MatDescr descrD,
        int nnzD, const rocblas_float_complex *csrValD, const int *csrRowPtrD,
        const int *csrColIndD, const MatDescr descrC, rocblas_float_complex *csrValC,
        const int *csrRowPtrC, int *csrColIndC, const csrgemm2Info_t info,
        void* pBuffer)

    Status cusparseZcsrgemm2(
        Handle handle, int m, int n, int k, const rocblas_double_complex *alpha,
        const MatDescr descrA, int nnzA, const rocblas_double_complex *csrValA,
        const int *csrRowPtrA, const int *csrColIndA, const MatDescr descrB,
        int nnzB, const rocblas_double_complex *csrValB, const int *csrRowPtrB,
        const int *csrColIndB, const rocblas_double_complex *beta,
        const MatDescr descrD, int nnzD, const rocblas_double_complex *csrValD,
        const int *csrRowPtrD, const int *csrColIndD, const MatDescr descrC,
        rocblas_double_complex *csrValC, const int *csrRowPtrC, int *csrColIndC,
    ...
    Status cusparseCcsc2dense(
        Handle handle, int m, int n, const MatDescr descrA,
        const rocblas_float_complex *cscSortedValA, const int *cscSortedRowIndA,
        const int *cscSortedColPtrA, rocblas_float_complex *A, int lda)

    Status cusparseZcsc2dense(
        Handle handle, int m, int n, const MatDescr descrA,
        const rocblas_double_complex *cscSortedValA, const int *cscSortedRowIndA,
        const int *cscSortedColPtrA, rocblas_double_complex *A, int lda)
    ...
    Status cusparseCcsr2csc(
        Handle handle, int m, int n, int nnz, const rocblas_float_complex *csrVal,
        const int *csrRowPtr, const int *csrColInd, rocblas_float_complex *cscVal,
        int *cscRowInd, int *cscColPtr, Action copyValues, IndexBase idxBase)

    Status cusparseZcsr2csc(
        Handle handle, int m, int n, int nnz, const rocblas_double_complex *csrVal,
        const int *csrRowPtr, const int *csrColInd, rocblas_double_complex *cscVal,
        int *cscRowInd, int *cscColPtr, Action copyValues, IndexBase idxBase)
    ...
    Status cusparseCcsr2dense(
        Handle handle, int m, int n, const MatDescr descrA,
        const rocblas_float_complex *csrSortedValA, const int *csrSortedRowPtrA,
        const int *csrSortedColIndA, rocblas_float_complex *A, int lda)

    Status cusparseZcsr2dense(
        Handle handle, int m, int n, const MatDescr descrA,
        const rocblas_double_complex *csrSortedValA, const int *csrSortedRowPtrA,
        const int *csrSortedColIndA, rocblas_double_complex *A, int lda)
    ...
    Status cusparseCnnz_compress(
        Handle handle, int m, const MatDescr descr,
        const rocblas_float_complex *values, const int *rowPtr, int *nnzPerRow,
        int *nnzTotal, rocblas_float_complex tol)

    Status cusparseZnnz_compress(
        Handle handle, int m, const MatDescr descr,
        const rocblas_double_complex *values, const int *rowPtr, int *nnzPerRow,
        int *nnzTotal, rocblas_double_complex tol)
    ...
    Status cusparseCcsr2csr_compress(
        Handle handle, int m, int n, const MatDescr descrA,
        const rocblas_float_complex *inVal, const int *inColInd, const int *inRowPtr,
        int inNnz, int *nnzPerRow, rocblas_float_complex *outVal, int *outColInd,
        int *outRowPtr, rocblas_float_complex tol)

    Status cusparseZcsr2csr_compress(
        Handle handle, int m, int n, const MatDescr descrA,
        const rocblas_double_complex *inVal, const int *inColInd, const int *inRowPtr,
        int inNnz, int *nnzPerRow, rocblas_double_complex *outVal, int *outColInd,
        int *outRowPtr, rocblas_double_complex tol)
    ...
    Status cusparseCdense2csc(
        Handle handle, int m, int n, const MatDescr descrA, const rocblas_float_complex *A,
        int lda, const int *nnzPerCol, rocblas_float_complex *cscValA, int *cscRowIndA,
        int *cscColPtrA)

    Status cusparseZdense2csc(
        Handle handle, int m, int n, const MatDescr descrA,
        const rocblas_double_complex *A,
        int lda, const int *nnzPerCol, rocblas_double_complex *cscValA,
    ...
    Status cusparseCdense2csr(
        Handle handle, int m, int n, const MatDescr descrA,
        const rocblas_float_complex *A, int lda, const int *nnzPerRow, rocblas_float_complex *csrValA,
        int *csrRowPtrA, int *csrColIndA)

    Status cusparseZdense2csr(
        Handle handle, int m, int n, const MatDescr descrA,
        const rocblas_double_complex *A, int lda, const int *nnzPerRow,
        rocblas_double_complex *csrValA,
        int *csrRowPtrA, int *csrColIndA)
    ...
    Status cusparseCnnz(
        Handle handle, Direction dirA, int m, int n, const MatDescr descrA,
        const rocblas_float_complex *A, int lda, int *nnzPerRowColumn,
        int *nnzTotalDevHostPtr)

    Status cusparseZnnz(
        Handle handle, Direction dirA, int m, int n, const MatDescr descrA,
        const rocblas_double_complex *A, int lda, int *nnzPerRowColumn,
        int *nnzTotalDevHostPtr)

    Status hipsparseCreateIdentityPermutation(
    ...
    hipsparseStatus_t cusparseCreateCsrilu02Info(csrilu02Info_t *info)
    hipsparseStatus_t cusparseDestroyCsrilu02Info(csrilu02Info_t info)
    ...
    hipsparseStatus_t cusparseCreateCsric02Info(csric02Info_t *info)
    hipsparseStatus_t cusparseDestroyCsric02Info(csric02Info_t info)
    ...
    hipsparseStatus_t cusparseScsrilu02_numericBoost(
        hipsparseHandle_t handle, csrilu02Info_t info, int enable_boost,
        double *tol, float *boost_val)
    hipsparseStatus_t cusparseDcsrilu02_numericBoost(
        hipsparseHandle_t handle, csrilu02Info_t info, int enable_boost,
        double *tol, double *boost_val)
    hipsparseStatus_t cusparseCcsrilu02_numericBoost(
        hipsparseHandle_t handle, csrilu02Info_t info, int enable_boost,
        double *tol, rocblas_float_complex *boost_val)
    hipsparseStatus_t cusparseZcsrilu02_numericBoost(
        hipsparseHandle_t handle, csrilu02Info_t info, int enable_boost,
        double *tol, rocblas_double_complex *boost_val)
    hipsparseStatus_t cusparseXcsrilu02_zeroPivot(
        hipsparseHandle_t handle, csrilu02Info_t info, int *position)
    hipsparseStatus_t cusparseScsrilu02_bufferSize(
    ...
    hipsparseStatus_t cusparseDcsrilu02_bufferSize(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, double *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csrilu02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseCcsrilu02_bufferSize(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, rocblas_float_complex *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csrilu02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseZcsrilu02_bufferSize(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, rocblas_double_complex *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csrilu02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseScsrilu02_analysis(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, const float *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseDcsrilu02_analysis(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, const double *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseCcsrilu02_analysis(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, const rocblas_float_complex *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseZcsrilu02_analysis(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, const rocblas_double_complex *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseScsrilu02(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, float *csrSortedValA_valM,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseDcsrilu02(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, double *csrSortedValA_valM,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseCcsrilu02(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, rocblas_float_complex *csrSortedValA_valM,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseZcsrilu02(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, rocblas_double_complex *csrSortedValA_valM,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseSbsrilu02_numericBoost(
        hipsparseHandle_t handle, bsrilu02Info_t info, int enable_boost,
        double *tol, float *boost_val)
    hipsparseStatus_t cusparseDbsrilu02_numericBoost(
        hipsparseHandle_t handle, bsrilu02Info_t info, int enable_boost,
        double *tol, double *boost_val)
    hipsparseStatus_t cusparseCbsrilu02_numericBoost(
        hipsparseHandle_t handle, bsrilu02Info_t info, int enable_boost,
        double *tol, rocblas_float_complex *boost_val)
    hipsparseStatus_t cusparseZbsrilu02_numericBoost(
        hipsparseHandle_t handle, bsrilu02Info_t info, int enable_boost,
        double *tol, rocblas_double_complex *boost_val)
    hipsparseStatus_t cusparseXbsrilu02_zeroPivot(
        hipsparseHandle_t handle, bsrilu02Info_t info, int *position)
    hipsparseStatus_t cusparseSbsrilu02_bufferSize(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, float *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsrilu02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseDbsrilu02_bufferSize(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, double *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsrilu02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseCbsrilu02_bufferSize(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, rocblas_float_complex *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsrilu02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseZbsrilu02_bufferSize(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, rocblas_double_complex *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsrilu02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseSbsrilu02_analysis(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, float *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseDbsrilu02_analysis(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, double *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseCbsrilu02_analysis(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, rocblas_float_complex *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseZbsrilu02_analysis(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, rocblas_double_complex *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseSbsrilu02(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, float *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseDbsrilu02(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, double *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseCbsrilu02(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, rocblas_float_complex *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseZbsrilu02(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, rocblas_double_complex *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsrilu02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseXcsric02_zeroPivot(
        hipsparseHandle_t handle, csric02Info_t info, int *position)
    hipsparseStatus_t cusparseScsric02_bufferSize(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, float *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csric02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseDcsric02_bufferSize(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, double *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csric02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseCcsric02_bufferSize(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, rocblas_float_complex *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csric02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseZcsric02_bufferSize(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, rocblas_double_complex *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csric02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseScsric02_analysis(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, const float *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csric02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseDcsric02_analysis(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, const double *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csric02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseCcsric02_analysis(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, const rocblas_float_complex *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csric02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseZcsric02_analysis(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, const rocblas_double_complex *csrSortedValA,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csric02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseScsric02(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, float *csrSortedValA_valM,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csric02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseDcsric02(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, double *csrSortedValA_valM,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csric02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseCcsric02(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, rocblas_float_complex *csrSortedValA_valM,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csric02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseZcsric02(
        hipsparseHandle_t handle, int m, int nnz,
        const hipsparseMatDescr_t descrA, rocblas_double_complex *csrSortedValA_valM,
        const int *csrSortedRowPtrA, const int *csrSortedColIndA,
        csric02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseXbsric02_zeroPivot(
        hipsparseHandle_t handle, bsric02Info_t info, int *position)
    hipsparseStatus_t cusparseSbsric02_bufferSize(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, float *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsric02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseDbsric02_bufferSize(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, double *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsric02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseCbsric02_bufferSize(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, rocblas_float_complex *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsric02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseZbsric02_bufferSize(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, rocblas_double_complex *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsric02Info_t info, int *pBufferSizeInBytes)
    hipsparseStatus_t cusparseSbsric02_analysis(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, const float *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsric02Info_t info, hipsparseSolvePolicy_t policy, void *pInputBuffer)
    hipsparseStatus_t cusparseDbsric02_analysis(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, const double *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsric02Info_t info, hipsparseSolvePolicy_t policy, void *pInputBuffer)
    hipsparseStatus_t cusparseCbsric02_analysis(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, const rocblas_float_complex *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsric02Info_t info, hipsparseSolvePolicy_t policy, void *pInputBuffer)
    hipsparseStatus_t cusparseZbsric02_analysis(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, const rocblas_double_complex *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsric02Info_t info, hipsparseSolvePolicy_t policy, void *pInputBuffer)
    hipsparseStatus_t cusparseSbsric02(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, float *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsric02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseDbsric02(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, double *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsric02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseCbsric02(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, rocblas_float_complex *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsric02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseZbsric02(
        hipsparseHandle_t handle, hipsparseDirection_t dirA, int mb, int nnzb,
        const hipsparseMatDescr_t descrA, rocblas_double_complex *bsrSortedVal,
        const int *bsrSortedRowPtr, const int *bsrSortedColInd, int blockDim,
        bsric02Info_t info, hipsparseSolvePolicy_t policy, void *pBuffer)
    hipsparseStatus_t cusparseSgtsv2_bufferSizeExt(
        hipsparseHandle_t handle, int m, int n, const float *dl, const float *d,
        const float *du, const float *B, int ldb, size_t *bufferSizeInBytes)
    hipsparseStatus_t cusparseDgtsv2_bufferSizeExt(
        hipsparseHandle_t handle, int m, int n, const double *dl,
        const double *d, const double *du, const double *B, int ldb,
        size_t *bufferSizeInBytes)
    hipsparseStatus_t cusparseCgtsv2_bufferSizeExt(
        hipsparseHandle_t handle, int m, int n, const rocblas_float_complex *dl,
        const rocblas_float_complex *d, const rocblas_float_complex *du, const rocblas_float_complex *B, int ldb,
        size_t *bufferSizeInBytes)
    hipsparseStatus_t cusparseZgtsv2_bufferSizeExt(
        hipsparseHandle_t handle, int m, int n, const rocblas_double_complex *dl,
        const rocblas_double_complex *d, const rocblas_double_complex *du,
        const rocblas_double_complex *B, int ldb, size_t *bufferSizeInBytes)
    ...
    hipsparseStatus_t cusparseCgtsv2(hipsparseHandle_t handle, int m, int n,
                                    const rocblas_float_complex *dl, const rocblas_float_complex *d,
                                    const rocblas_float_complex *du, rocblas_float_complex *B, int ldb,
                                    void *pBuffer)
    hipsparseStatus_t cusparseZgtsv2(
        hipsparseHandle_t handle, int m, int n, const rocblas_double_complex *dl,
        const rocblas_double_complex *d, const rocblas_double_complex *du,
        rocblas_double_complex *B, int ldb, void *pBuffer)
    ...
    hipsparseStatus_t cusparseCgtsv2_nopivot(
        hipsparseHandle_t handle, int m, int n, const rocblas_float_complex *dl,
        const rocblas_float_complex *d, const rocblas_float_complex *du, rocblas_float_complex *B, int ldb,
        void *pBuffer)
    ...
    hipsparseStatus_t cusparseSgtsv2StridedBatch_bufferSizeExt(
        hipsparseHandle_t handle, int m, const float *dl, const float *d,
        const float *du, const float *x, int batchCount, int batchStride,
        size_t *bufferSizeInBytes)
    hipsparseStatus_t cusparseDgtsv2StridedBatch_bufferSizeExt(
        hipsparseHandle_t handle, int m, const double *dl, const double *d,
        const double *du, const double *x, int batchCount, int batchStride,
        size_t *bufferSizeInBytes)
    hipsparseStatus_t cusparseCgtsv2StridedBatch_bufferSizeExt(
        hipsparseHandle_t handle, int m, const rocblas_float_complex *dl,
        const rocblas_float_complex *d, const rocblas_float_complex *du, const rocblas_float_complex *x,
        int batchCount, int batchStride, size_t *bufferSizeInBytes)
    hipsparseStatus_t cusparseZgtsv2StridedBatch_bufferSizeExt(
        hipsparseHandle_t handle, int m, const rocblas_double_complex *dl,
        const rocblas_double_complex *d, const rocblas_double_complex *du,
        const rocblas_double_complex *x, int batchCount, int batchStride,
        size_t *bufferSizeInBytes)
    ...
    hipsparseStatus_t cusparseCgtsv2StridedBatch(
        hipsparseHandle_t handle, int m, const rocblas_float_complex *dl,
        const rocblas_float_complex *d, const rocblas_float_complex *du, rocblas_float_complex *x, int batchCount,
        int batchStride, void *pBuffer)
    hipsparseStatus_t cusparseZgtsv2StridedBatch(
        hipsparseHandle_t handle, int m, const rocblas_double_complex *dl,
        const rocblas_double_complex *d, const rocblas_double_complex *du,
        rocblas_double_complex *x, int batchCount, int batchStride, void *pBuffer)
    hipsparseStatus_t cusparseSgtsvInterleavedBatch_bufferSizeExt(
        hipsparseHandle_t handle, int algo, int m, const float *dl,
    ...
    hipsparseStatus_t cusparseDgtsvInterleavedBatch_bufferSizeExt(
        hipsparseHandle_t handle, int algo, int m, const double *dl,
    ...
    hipsparseStatus_t cusparseCgtsvInterleavedBatch_bufferSizeExt(
        hipsparseHandle_t handle, int algo, int m, const rocblas_float_complex *dl,
        const rocblas_float_complex *d, const rocblas_float_complex *du, const rocblas_float_complex *x,
        int batchCount, size_t *pBufferSizeInBytes)
    hipsparseStatus_t cusparseZgtsvInterleavedBatch_bufferSizeExt(
        hipsparseHandle_t handle, int algo, int m, const rocblas_double_complex *dl,
        const rocblas_double_complex *d, const rocblas_double_complex *du,
        const rocblas_double_complex *x, int batchCount, size_t *pBufferSizeInBytes)
    hipsparseStatus_t cusparseSgtsvInterleavedBatch(
        hipsparseHandle_t handle, int algo, int m, float *dl, float *d,
        float *du, float *x, int batchCount, void *pBuffer)
    hipsparseStatus_t cusparseDgtsvInterleavedBatch(
        hipsparseHandle_t handle, int algo, int m, double *dl, double *d,
        double *du, double *x, int batchCount, void *pBuffer)
    hipsparseStatus_t cusparseCgtsvInterleavedBatch(
        hipsparseHandle_t handle, int algo, int m, rocblas_float_complex *dl, rocblas_float_complex *d,
        rocblas_float_complex *du, rocblas_float_complex *x, int batchCount, void *pBuffer)
    hipsparseStatus_t cusparseZgtsvInterleavedBatch(
        hipsparseHandle_t handle, int algo, int m, rocblas_double_complex *dl,
        rocblas_double_complex *d, rocblas_double_complex *du, rocblas_double_complex *x,
        int batchCount, void *pBuffer)
    hipsparseStatus_t cusparseSgpsvInterleavedBatch_bufferSizeExt(
        hipsparseHandle_t handle, int algo, int m, const float *ds,
    ...
    hipsparseStatus_t cusparseDgpsvInterleavedBatch_bufferSizeExt(
        hipsparseHandle_t handle, int algo, int m, const double *ds,
    ...
    hipsparseStatus_t cusparseCgpsvInterleavedBatch_bufferSizeExt(
        hipsparseHandle_t handle, int algo, int m, const rocblas_float_complex *ds,
        const rocblas_float_complex *dl, const rocblas_float_complex *d, const rocblas_float_complex *du,
        const rocblas_float_complex *dw, const rocblas_float_complex *x, int batchCount,
        size_t *pBufferSizeInBytes)
    hipsparseStatus_t cusparseZgpsvInterleavedBatch_bufferSizeExt(
        hipsparseHandle_t handle, int algo, int m, const rocblas_double_complex *ds,
        const rocblas_double_complex *dl, const rocblas_double_complex *d,
        const rocblas_double_complex *du, const rocblas_double_complex *dw,
        const rocblas_double_complex *x, int batchCount, size_t *pBufferSizeInBytes)
    hipsparseStatus_t cusparseSgpsvInterleavedBatch(
        hipsparseHandle_t handle, int algo, int m, float *ds, float *dl,
        float *d, float *du, float *dw, float *x, int batchCount,
        void *pBuffer)
    hipsparseStatus_t cusparseDgpsvInterleavedBatch(
        hipsparseHandle_t handle, int algo, int m, double *ds, double *dl,
        double *d, double *du, double *dw, double *x, int batchCount,
        void *pBuffer)
    hipsparseStatus_t cusparseCgpsvInterleavedBatch(
        hipsparseHandle_t handle, int algo, int m, rocblas_float_complex *ds, rocblas_float_complex *dl,
        rocblas_float_complex *d, rocblas_float_complex *du, rocblas_float_complex *dw, rocblas_float_complex *x,
        int batchCount, void *pBuffer)
    hipsparseStatus_t cusparseZgpsvInterleavedBatch(
        hipsparseHandle_t handle, int algo, int m, rocblas_double_complex *ds,
        rocblas_double_complex *dl, rocblas_double_complex *d, rocblas_double_complex *du,
        rocblas_double_complex *dw, rocblas_double_complex *x, int batchCount, void *pBuffer)
    ...
    # Sparse Matrix APIs
    Status hipsparseCreateCoo(SpMatDescr* spMatDescr, int64_t rows,
    ...
    Status cusparseCreateCooAoS(SpMatDescr* spMatDescr, int64_t rows,
                                ...
                                IndexBase idxBase, DataType valueType)
    Status hipsparseCreateCsr(SpMatDescr* spMatDescr, int64_t rows,
                             ...
                             DataType valueType)
    Status hipsparseDestroySpMat(SpMatDescr spMatDescr)
    ...
    Status cusparseCsrGet(SpMatDescr spMatDescr, int64_t* rows, int64_t* cols,
                          ...
                          IndexType* csrColIndType, IndexBase* idxBase,
                          DataType* valueType)
    Status hipsparseCsrSetPointers(SpMatDescr spMatDescr, void* csrRowOffsets,
                                  void* csrColInd, void* csrValues)
    ...
    Status hipsparseSpMatGetSize(SpMatDescr spMatDescr, int64_t* rows,
    ...
    # Dense Vector APIs
    Status hipsparseCreateDnVec(DnVecDescr *dnVecDescr, int64_t size,
                               void* values, DataType valueType)
    Status hipsparseDestroyDnVec(DnVecDescr dnVecDescr)
    ...
    # Dense Matrix APIs
    Status hipsparseCreateDnMat(DnMatDescr* dnMatDescr, int64_t rows,
                               int64_t cols, int64_t ld, void* values,
                               DataType valueType, Order order)
    Status hipsparseDestroyDnMat(DnMatDescr dnVecDescr)
    ...
    Status cusparseDnMatGetStridedBatch(DnMatDescr dnMatDescr, int* batchCount,
                                        int64_t *batchStride)
    Status hipsparseDnMatSetStridedBatch(DnMatDescr dnMatDescr, int batchCount,
                                        int64_t batchStride)
    ...
    Status hipsparseSpGEMM_createDescr(SpGEMMDescr* spgemmDescr)
    Status hipsparseSpGEMM_destroyDescr(SpGEMMDescr spgemmDescr)
    ...
    Status hipsparseSpGEMM_compute(
        Handle handle, Operation opA, Operation opB, const void* alpha,
        SpMatDescr matA, SpMatDescr matB, const void* beta, SpMatDescr matC,
        DataType computeType, SpGEMMAlg alg, SpGEMMDescr spgemmDescr,
        size_t* bufferSize2, void* externalBuffer2)
    Status hipsparseSpGEMM_copy(
        Handle handle, Operation opA, Operation opB, const void* alpha,
        SpMatDescr matA, SpMatDescr matB, const void* beta, SpMatDescr matC,
        DataType computeType, SpGEMMAlg alg, SpGEMMDescr spgemmDescr)
...
@cython.profile(False)
cdef inline rocblas_float_complex complex_to_cuda(complex value):
    cdef rocblas_float_complex value_cuda
...
@cython.profile(False)
cdef inline rocblas_double_complex double_complex_to_cuda(double complex value):
    cdef rocblas_double_complex value_cuda
    value_cuda.x = value.real
    value_cuda.y = value.imag
    return value_cuda
...
cpdef setMatIndexBase(size_t descr, base):
    status = hipsparseSetMatIndexBase(<MatDescr>descr, base)
    check_status(status)


cpdef setMatType(size_t descr, typ):
    status = hipsparseSetMatType(<MatDescr>descr, typ)
    check_status(status)
...
cpdef setStream(intptr_t handle, size_t stream):
    ...
    status = hipsparseSetStream(<Handle>handle, <Stream>stream)
    check_status(status)
...
cpdef cgthr(intptr_t handle, int nnz, size_t y, size_t xVal, size_t xInd,
    ...
    _setStream(handle)
    status = cusparseCgthr(
        <Handle>handle, nnz, <const rocblas_float_complex *>y, <rocblas_float_complex *>xVal,
        <const int *>xInd, <IndexBase>idxBase)
    check_status(status)
...
cpdef zgthr(intptr_t handle, int nnz, size_t y, size_t xVal, size_t xInd,
    ...
    _setStream(handle)
    status = cusparseZgthr(
        <Handle>handle, nnz, <const rocblas_double_complex *>y,
        <rocblas_double_complex *>xVal, <const int *>xInd, <IndexBase>idxBase)
    check_status(status)
...
cpdef ccsrmm(
    ...
    status = cusparseCcsrmm(
        ...
        <const rocblas_float_complex *>csrSortedValA,
        <const int *>csrSortedRowPtrA, <const int *>csrSortedColIndA,
        <const rocblas_float_complex *>B, ldb, <const rocblas_float_complex *>beta,
...
cpdef ccsrmm2(
    ...
    status = hipsparseCcsrmm2(
        <Handle>handle, <Operation>transA, <Operation>transB, m, n, k, nnz,
        <const rocblas_float_complex *>alpha, <MatDescr>descrA, <const rocblas_float_complex *>csrValA,
        <const int *>csrRowPtrA, <const int *>csrColIndA,
        <const rocblas_float_complex *>B, ldb, <const rocblas_float_complex *>beta,
        <rocblas_float_complex *>C, ldc)
    check_status(status)
...
cpdef scsrsm2_bufferSizeExt(
    ...
    status = cusparseScsrsm2_bufferSizeExt(
        ...
        <csrsm2Info_t>info, <hipsparseSolvePolicy_t>policy, &bufferSize)
    check_status(status)
    return bufferSize
...
cpdef ccsrsm2_bufferSizeExt(
    ...
    status = cusparseCcsrsm2_bufferSizeExt(
        <Handle>handle, algo, <Operation>transA, <Operation>transB, m, nrhs,
        nnz, <const rocblas_float_complex*>alpha, <const MatDescr>descrA,
        <const rocblas_float_complex*>csrSortedValA, <const int*>csrSortedRowPtrA,
        <const int*>csrSortedColIndA, <rocblas_float_complex*>B, ldb,
        <csrsm2Info_t>info, <hipsparseSolvePolicy_t>policy, &bufferSize)
    check_status(status)
    return bufferSize
...
cpdef zcsrsm2_bufferSizeExt(
    ...
    status = cusparseZcsrsm2_bufferSizeExt(
        <Handle>handle, algo, <Operation>transA, <Operation>transB, m, nrhs,
        nnz, <const rocblas_double_complex*>alpha, <const MatDescr>descrA,
        <const rocblas_double_complex*>csrSortedValA, <const int*>csrSortedRowPtrA,
        <const int*>csrSortedColIndA, <rocblas_double_complex*>B, ldb,
        <csrsm2Info_t>info, <hipsparseSolvePolicy_t>policy, &bufferSize)
    check_status(status)
    return bufferSize
...
cpdef scsrsm2_analysis(
    ...
    status = cusparseScsrsm2_analysis(
        ...
        <const float*>csrSortedValA, <const int*>csrSortedRowPtrA,
        <const int*>csrSortedColIndA, <float*>B, ldb,
        <csrsm2Info_t>info, <hipsparseSolvePolicy_t>policy, <void*>pBuffer)
    check_status(status)
...
cpdef ccsrgeam(
    ...
    _setStream(handle)
    status = cusparseCcsrgeam(
        <Handle>handle, m, n, <const rocblas_float_complex *>alpha,
        <const MatDescr>descrA, nnzA, <const rocblas_float_complex *>csrValA,
        <const int *>csrRowPtrA, <const int *>csrColIndA,
        <const rocblas_float_complex *>beta,
        <const MatDescr>descrB, nnzB, <const rocblas_float_complex *>csrValB,
        <const int *>csrRowPtrB, <const int *>csrColIndB,
        <const MatDescr>descrC, <rocblas_float_complex *>csrValC, <int *>csrRowPtrC,
        <int *>csrColIndC)
    check_status(status)
...
cpdef zcsrgeam(
    ...
    _setStream(handle)
    status = cusparseZcsrgeam(
        <Handle>handle, m, n, <const rocblas_double_complex *>alpha,
        <const MatDescr>descrA, nnzA, <const rocblas_double_complex *>csrValA,
        <const int *>csrRowPtrA, <const int *>csrColIndA,
        <const rocblas_double_complex *>beta,
        <const MatDescr>descrB, nnzB, <const rocblas_double_complex *>csrValB,
        <const int *>csrRowPtrB, <const int *>csrColIndB,
        <const MatDescr>descrC, <rocblas_double_complex *>csrValC, <int *>csrRowPtrC,
        <int *>csrColIndC)
    check_status(status)
...
cpdef ccsrgemm(
    ...
    status = cusparseCcsrgemm(
        ...
        <const MatDescr>descrB, nnzB, <const rocblas_float_complex *>csrValB,
        <const int *>csrRowPtrB, <const int *>csrColIndB,
        <const MatDescr>descrC, <rocblas_float_complex *>csrValC,
        <const int *>csrRowPtrC, <int *>csrColIndC)
    check_status(status)
...
cpdef zcsrgemm(
    ...
    status = cusparseZcsrgemm(
        ...
        <const MatDescr>descrB, nnzB, <const rocblas_double_complex *>csrValB,
        <const int *>csrRowPtrB, <const int *>csrColIndB,
        <const MatDescr>descrC, <rocblas_double_complex *>csrValC,
        <const int *>csrRowPtrC, <int *>csrColIndC)
    check_status(status)
...
cpdef size_t createCsrgemm2Info():
    ...
    with nogil:
        status = hipsparseCreateCsrgemm2Info(&info)
    check_status(status)
    return <size_t>info

cpdef destroyCsrgemm2Info(size_t info):
    with nogil:
        status = hipsparseDestroyCsrgemm2Info(<csrgemm2Info_t>info)
    check_status(status)
...
cpdef ccsrgemm2(
    ...
    _setStream(handle)
    status = cusparseCcsrgemm2(
        <Handle>handle, m, n, k, <rocblas_float_complex*>alpha, <MatDescr>descrA, nnzA,
        <rocblas_float_complex*>csrValA, <int*>csrRowPtrA, <int*>csrColIndA,
        <MatDescr>descrB, nnzB, <rocblas_float_complex*>csrValB, <int*>csrRowPtrB,
        <int*>csrColIndB, <rocblas_float_complex*>beta, <MatDescr>descrD, nnzD,
        <rocblas_float_complex*>csrValD, <int*>csrRowPtrD, <int*>csrColIndD,
        <MatDescr>descrC, <rocblas_float_complex*>csrValC, <int*>csrRowPtrC,
...
cpdef zcsrgemm2(
    ...
    _setStream(handle)
    status = cusparseZcsrgemm2(
        <Handle>handle, m, n, k, <rocblas_double_complex*>alpha, <MatDescr>descrA,
        nnzA, <rocblas_double_complex*>csrValA, <int*>csrRowPtrA, <int*>csrColIndA,
        <MatDescr>descrB, nnzB, <rocblas_double_complex*>csrValB, <int*>csrRowPtrB,
        <int*>csrColIndB, <rocblas_double_complex*>beta, <MatDescr>descrD, nnzD,
        <rocblas_double_complex*>csrValD, <int*>csrRowPtrD, <int*>csrColIndD,
        <MatDescr>descrC, <rocblas_double_complex*>csrValC, <int*>csrRowPtrC,
        <int*>csrColIndC, <csrgemm2Info_t>info, <void*>pBuffer)
    check_status(status)
...
cpdef ccsc2dense(
    ...
    status = cusparseCcsc2dense(
        <Handle>handle, m, n, <MatDescr>descrA,
        <const rocblas_float_complex *>cscSortedValA, <const int *>cscSortedRowIndA,
        <const int *>cscSortedColPtrA, <rocblas_float_complex *>A, lda)
    check_status(status)
...
cpdef zcsc2dense(
    ...
    status = cusparseZcsc2dense(
        <Handle>handle, m, n, <MatDescr>descrA,
        <const rocblas_double_complex *>cscSortedValA, <const int *>cscSortedRowIndA,
        <const int *>cscSortedColPtrA, <rocblas_double_complex *>A, lda)
    check_status(status)
...
cpdef ccsr2csc(
    ...
    _setStream(handle)
    status = cusparseCcsr2csc(
        <Handle>handle, m, n, nnz, <const rocblas_float_complex *>csrVal,
        <const int *>csrRowPtr, <const int *>csrColInd, <rocblas_float_complex *>cscVal,
        <int *>cscRowInd, <int *>cscColPtr, <Action>copyValues,
        <IndexBase>idxBase)
    check_status(status)
...
cpdef zcsr2csc(
    ...
    _setStream(handle)
    status = cusparseZcsr2csc(
        <Handle>handle, m, n, nnz, <const rocblas_double_complex *>csrVal,
        <const int *>csrRowPtr, <const int *>csrColInd,
        <rocblas_double_complex *>cscVal,
        <int *>cscRowInd, <int *>cscColPtr, <Action>copyValues,
        <IndexBase>idxBase)
    check_status(status)
...
cpdef ccsr2dense(
    ...
    status = cusparseCcsr2dense(
        <Handle>handle, m, n, <MatDescr>descrA,
        <const rocblas_float_complex *>csrSortedValA, <const int *>csrSortedRowPtrA,
        <const int *>csrSortedColIndA, <rocblas_float_complex *>A, lda)
    check_status(status)
...
cpdef zcsr2dense(
    ...
    status = cusparseZcsr2dense(
        <Handle>handle, m, n, <MatDescr>descrA,
        <const rocblas_double_complex *>csrSortedValA, <const int *>csrSortedRowPtrA,
        <const int *>csrSortedColIndA, <rocblas_double_complex *>A, lda)
    check_status(status)
...
cpdef ccsr2csr_compress(
    ...
    status = cusparseCcsr2csr_compress(
        <Handle>handle, m, n, <MatDescr>descrA,
        <const rocblas_float_complex *>inVal, <const int *>inColInd, <const int *>inRowPtr,
        inNnz, <int *>nnzPerRow, <rocblas_float_complex *>outVal, <int *>outColInd,
...
cpdef zcsr2csr_compress(
    ...
    status = cusparseZcsr2csr_compress(
        <Handle>handle, m, n, <MatDescr>descrA,
        <const rocblas_double_complex *>inVal, <const int *>inColInd,
        <const int *>inRowPtr,
        inNnz, <int *>nnzPerRow, <rocblas_double_complex *>outVal, <int *>outColInd,
...
cpdef cdense2csc(
    ...
    _setStream(handle)
    status = cusparseCdense2csc(
        <Handle>handle, m, n, <const MatDescr>descrA, <const rocblas_float_complex *>A,
        lda, <const int *>nnzPerCol, <rocblas_float_complex *>cscValA, <int *>cscRowIndA,
        <int *>cscColPtrA)
    check_status(status)
...
cpdef zdense2csc(
    ...
    status = cusparseZdense2csc(
        <Handle>handle, m, n,
        <const MatDescr>descrA, <const rocblas_double_complex *>A,
        lda, <const int *>nnzPerCol,
        <rocblas_double_complex *>cscValA, <int *>cscRowIndA,
        <int *>cscColPtrA)
    check_status(status)
...
cpdef cdense2csr(
    ...
    status = cusparseCdense2csr(
        <Handle>handle, m, n, <MatDescr>descrA,
        <const rocblas_float_complex *>A, lda, <const int *>nnzPerRow,
        <rocblas_float_complex *>csrValA, <int *>csrRowPtrA, <int *>csrColIndA)
    check_status(status)
...
cpdef zdense2csr(
    ...
    status = cusparseZdense2csr(
        <Handle>handle, m, n, <MatDescr>descrA,
        <const rocblas_double_complex *>A, lda, <const int *>nnzPerRow,
        <rocblas_double_complex *>csrValA, <int *>csrRowPtrA, <int *>csrColIndA)
    check_status(status)
...
cpdef cnnz(
    ...
    status = cusparseCnnz(
        <Handle>handle, <Direction>dirA, m, n, <const MatDescr>descrA,
        <const rocblas_float_complex *>A, lda, <int *>nnzPerRowColumn,
        <int *>nnzTotalDevHostPtr)
    check_status(status)
...
cpdef znnz(
    ...
    status = cusparseZnnz(
        <Handle>handle, <Direction>dirA, m, n, <const MatDescr>descrA,
        <const rocblas_double_complex *>A, lda, <int *>nnzPerRowColumn,
        <int *>nnzTotalDevHostPtr)
    check_status(status)
...
cpdef scsrilu02_numericBoost(intptr_t handle, size_t info, int enable_boost,
    ...
    with nogil:
        status = cusparseScsrilu02_numericBoost(
            <hipsparseHandle_t>handle, <csrilu02Info_t>info, enable_boost,
            <double*>tol, <float*>boost_val)
    check_status(status)
...
cpdef int scsrilu02_bufferSize(intptr_t handle, int m, int nnz, size_t descrA,
    ...
    with nogil:
        status = cusparseScsrilu02_bufferSize(
            <hipsparseHandle_t>handle, m, nnz, <const hipsparseMatDescr_t>descrA,
            <float*>csrSortedValA, <const int*>csrSortedRowPtrA,
...
cpdef ccsrilu02(intptr_t handle, int m, int nnz, size_t descrA,
    ...
    with nogil:
        status = cusparseCcsrilu02(
            <hipsparseHandle_t>handle, m, nnz, <const hipsparseMatDescr_t>descrA,
            <rocblas_float_complex*>csrSortedValA_valM, <const int*>csrSortedRowPtrA,
            <const int*>csrSortedColIndA, <csrilu02Info_t>info,
            <hipsparseSolvePolicy_t>policy, <void*>pBuffer)
    check_status(status)
...
cpdef zcsrilu02(intptr_t handle, int m, int nnz, size_t descrA,
    ...
    with nogil:
        status = cusparseZcsrilu02(
            <hipsparseHandle_t>handle, m, nnz, <const hipsparseMatDescr_t>descrA,
            <rocblas_double_complex*>csrSortedValA_valM, <const int*>csrSortedRowPtrA,
            <const int*>csrSortedColIndA, <csrilu02Info_t>info,
            <hipsparseSolvePolicy_t>policy, <void*>pBuffer)
    check_status(status)
...
cpdef sbsrilu02_numericBoost(intptr_t handle, size_t info, int enable_boost,
    ...
    with nogil:
        status = cusparseSbsrilu02_numericBoost(
            <hipsparseHandle_t>handle, <bsrilu02Info_t>info, enable_boost,
            <double*>tol, <float*>boost_val)
    check_status(status)
...
cpdef int sbsrilu02_bufferSize(intptr_t handle, int dirA, int mb, int nnzb,
    ...
    with nogil:
        status = cusparseSbsrilu02_bufferSize(
            <hipsparseHandle_t>handle, <hipsparseDirection_t>dirA, mb, nnzb,
            <const hipsparseMatDescr_t>descrA, <float*>bsrSortedVal,
...
cpdef sbsrilu02_analysis(
    ...
    with nogil:
        status = cusparseSbsrilu02_analysis(
            ...
            <const hipsparseMatDescr_t>descrA, <float*>bsrSortedVal,
            <const int*>bsrSortedRowPtr, <const int*>bsrSortedColInd, blockDim,
            <bsrilu02Info_t>info, <hipsparseSolvePolicy_t>policy,
            <void*>pBuffer)
    check_status(status)
...
cpdef sbsric02_analysis(
    ...
    with nogil:
        status = cusparseSbsric02_analysis(
            ...
            <const hipsparseMatDescr_t>descrA, <const float*>bsrSortedVal,
            <const int*>bsrSortedRowPtr, <const int*>bsrSortedColInd, blockDim,
            <bsric02Info_t>info, <hipsparseSolvePolicy_t>policy,
            <void*>pInputBuffer)
    check_status(status)
...
cpdef zbsric02_analysis(
    ...
    with nogil:
        status = cusparseZbsric02_analysis(
            ...
            <const rocblas_double_complex*>bsrSortedVal, <const int*>bsrSortedRowPtr,
            <const int*>bsrSortedColInd, blockDim, <bsric02Info_t>info,
            <hipsparseSolvePolicy_t>policy, <void*>pInputBuffer)
    check_status(status)
...
cpdef sgtsv2_bufferSizeExt(intptr_t handle, int m, int n, size_t dl, size_t d,
    ...
    with nogil:
        status = cusparseSgtsv2_bufferSizeExt(
            <hipsparseHandle_t>handle, m, n, <const float*>dl, <const float*>d,
...
cpdef dgtsv2_bufferSizeExt(intptr_t handle, int m, int n, size_t dl, size_t d,
    ...
    with nogil:
        status = cusparseDgtsv2_bufferSizeExt(
            <hipsparseHandle_t>handle, m, n, <const double*>dl,
...
cpdef cgtsv2_bufferSizeExt(intptr_t handle, int m, int n, size_t dl, size_t d,
    ...
    with nogil:
        status = cusparseCgtsv2_bufferSizeExt(
            <hipsparseHandle_t>handle, m, n, <const rocblas_float_complex*>dl,
            <const rocblas_float_complex*>d, <const rocblas_float_complex*>du, <const rocblas_float_complex*>B,
...
cpdef zgtsv2_bufferSizeExt(intptr_t handle, int m, int n, size_t dl, size_t d,
    ...
    with nogil:
        status = cusparseZgtsv2_bufferSizeExt(
            <hipsparseHandle_t>handle, m, n, <const rocblas_double_complex*>dl,
            <const rocblas_double_complex*>d, <const rocblas_double_complex*>du,
            <const rocblas_double_complex*>B, ldb, <size_t*>bufferSizeInBytes)
    check_status(status)
...
cpdef dgtsv2(intptr_t handle, int m, int n, size_t dl, size_t d, size_t du,
    ...
    _setStream(handle)
    with nogil:
        status = cusparseDgtsv2(<hipsparseHandle_t>handle, m, n,
...
cpdef cgtsv2(intptr_t handle, int m, int n, size_t dl, size_t d, size_t du,
    ...
    _setStream(handle)
    with nogil:
        status = cusparseCgtsv2(<hipsparseHandle_t>handle, m, n,
                                <const rocblas_float_complex*>dl, <const rocblas_float_complex*>d,
                                <const rocblas_float_complex*>du, <rocblas_float_complex*>B, ldb,
                                <void*>pBuffer)
    check_status(status)
...
cpdef zgtsv2(intptr_t handle, int m, int n, size_t dl, size_t d, size_t du,
    ...
    with nogil:
        status = cusparseZgtsv2(
            <hipsparseHandle_t>handle, m, n, <const rocblas_double_complex*>dl,
            <const rocblas_double_complex*>d, <const rocblas_double_complex*>du,
            <rocblas_double_complex*>B, ldb, <void*>pBuffer)
    check_status(status)
...
cpdef dgtsv2_nopivot(intptr_t handle, int m, int n, size_t dl, size_t d,
    ...
    _setStream(handle)
    with nogil:
        status = cusparseDgtsv2_nopivot(<hipsparseHandle_t>handle, m, n,
                                        <const double*>dl, <const double*>d,
                                        <const double*>du, <double*>B, ldb,
                                        <void*>pBuffer)
    check_status(status)
...
cpdef cgtsv2_nopivot(intptr_t handle, int m, int n, size_t dl, size_t d,
    ...
    with nogil:
        status = cusparseCgtsv2_nopivot(
            <hipsparseHandle_t>handle, m, n, <const rocblas_float_complex*>dl,
            <const rocblas_float_complex*>d, <const rocblas_float_complex*>du, <rocblas_float_complex*>B, ldb,
            <void*>pBuffer)
    check_status(status)
...
cpdef sgtsv2StridedBatch_bufferSizeExt(
    ...
    with nogil:
        status = cusparseSgtsv2StridedBatch_bufferSizeExt(
            <hipsparseHandle_t>handle, m, <const float*>dl, <const float*>d,
...
cpdef dgtsv2StridedBatch_bufferSizeExt(
    ...
    with nogil:
        status = cusparseDgtsv2StridedBatch_bufferSizeExt(
            <hipsparseHandle_t>handle, m, <const double*>dl, <const double*>d,
...
cpdef cgtsv2StridedBatch_bufferSizeExt(
    ...
    with nogil:
        status = cusparseCgtsv2StridedBatch_bufferSizeExt(
            <hipsparseHandle_t>handle, m, <const rocblas_float_complex*>dl,
            <const rocblas_float_complex*>d, <const rocblas_float_complex*>du, <const rocblas_float_complex*>x,
...
cpdef zgtsv2StridedBatch_bufferSizeExt(
    ...
    with nogil:
        status = cusparseZgtsv2StridedBatch_bufferSizeExt(
            <hipsparseHandle_t>handle, m, <const rocblas_double_complex*>dl,
            <const rocblas_double_complex*>d, <const rocblas_double_complex*>du,
            <const rocblas_double_complex*>x, batchCount, batchStride,
            <size_t*>bufferSizeInBytes)
    check_status(status)
...
cpdef cgtsv2StridedBatch(intptr_t handle, int m, size_t dl, size_t d,
    ...
    with nogil:
        status = cusparseCgtsv2StridedBatch(
            <hipsparseHandle_t>handle, m, <const rocblas_float_complex*>dl,
            <const rocblas_float_complex*>d, <const rocblas_float_complex*>du, <rocblas_float_complex*>x,
...
cpdef zgtsv2StridedBatch(intptr_t handle, int m, size_t dl, size_t d,
    ...
    with nogil:
        status = cusparseZgtsv2StridedBatch(
            <hipsparseHandle_t>handle, m, <const rocblas_double_complex*>dl,
            <const rocblas_double_complex*>d, <const rocblas_double_complex*>du,
            <rocblas_double_complex*>x, batchCount, batchStride, <void*>pBuffer)
    check_status(status)
...
cpdef size_t sgtsvInterleavedBatch_bufferSizeExt(
    ...
    with nogil:
        status = cusparseSgtsvInterleavedBatch_bufferSizeExt(
            <hipsparseHandle_t>handle, algo, m, <const float*>dl,
...
cpdef size_t dgtsvInterleavedBatch_bufferSizeExt(
    ...
    with nogil:
        status = cusparseDgtsvInterleavedBatch_bufferSizeExt(
            <hipsparseHandle_t>handle, algo, m, <const double*>dl,
...
cpdef size_t cgtsvInterleavedBatch_bufferSizeExt(
    ...
    with nogil:
        status = cusparseCgtsvInterleavedBatch_bufferSizeExt(
            <hipsparseHandle_t>handle, algo, m, <const rocblas_float_complex*>dl,
            <const rocblas_float_complex*>d, <const rocblas_float_complex*>du, <const rocblas_float_complex*>x,
...
cpdef size_t zgtsvInterleavedBatch_bufferSizeExt(
    ...
    with nogil:
        status = cusparseZgtsvInterleavedBatch_bufferSizeExt(
            <hipsparseHandle_t>handle, algo, m, <const rocblas_double_complex*>dl,
            <const rocblas_double_complex*>d, <const rocblas_double_complex*>du,
            <const rocblas_double_complex*>x, batchCount, &pBufferSizeInBytes)
    check_status(status)
    return <size_t>pBufferSizeInBytes
...
cpdef sgtsvInterleavedBatch(intptr_t handle, int algo, int m, size_t dl,
    ...
    with nogil:
        status = cusparseSgtsvInterleavedBatch(
            <hipsparseHandle_t>handle, algo, m, <float*>dl, <float*>d,
...
cpdef dgtsvInterleavedBatch(intptr_t handle, int algo, int m, size_t dl,
    ...
    with nogil:
        status = cusparseDgtsvInterleavedBatch(
            <hipsparseHandle_t>handle, algo, m, <double*>dl, <double*>d,
...
cpdef cgtsvInterleavedBatch(intptr_t handle, int algo, int m, size_t dl,
    ...
    with nogil:
        status = cusparseCgtsvInterleavedBatch(
            <hipsparseHandle_t>handle, algo, m, <rocblas_float_complex*>dl, <rocblas_float_complex*>d,
            <rocblas_float_complex*>du, <rocblas_float_complex*>x, batchCount, <void*>pBuffer)
    check_status(status)
...
cpdef zgtsvInterleavedBatch(intptr_t handle, int algo, int m, size_t dl,
    ...
    with nogil:
        status = cusparseZgtsvInterleavedBatch(
            <hipsparseHandle_t>handle, algo, m, <rocblas_double_complex*>dl,
            <rocblas_double_complex*>d, <rocblas_double_complex*>du, <rocblas_double_complex*>x,
...
cpdef size_t sgpsvInterleavedBatch_bufferSizeExt(
    ...
    with nogil:
        status = cusparseSgpsvInterleavedBatch_bufferSizeExt(
            <hipsparseHandle_t>handle, algo, m, <const float*>ds,
...
cpdef size_t dgpsvInterleavedBatch_bufferSizeExt(
    ...
    with nogil:
        status = cusparseDgpsvInterleavedBatch_bufferSizeExt(
            <hipsparseHandle_t>handle, algo, m, <const double*>ds,
...
cpdef size_t cgpsvInterleavedBatch_bufferSizeExt(
    ...
    with nogil:
        status = cusparseCgpsvInterleavedBatch_bufferSizeExt(
            <hipsparseHandle_t>handle, algo, m, <const rocblas_float_complex*>ds,
            <const rocblas_float_complex*>dl, <const rocblas_float_complex*>d, <const rocblas_float_complex*>du,
            <const rocblas_float_complex*>dw, <const rocblas_float_complex*>x, batchCount,
            &pBufferSizeInBytes)
    check_status(status)
    return <size_t>pBufferSizeInBytes
...
cpdef size_t zgpsvInterleavedBatch_bufferSizeExt(
    ...
    with nogil:
        status = cusparseZgpsvInterleavedBatch_bufferSizeExt(
            <hipsparseHandle_t>handle, algo, m, <const rocblas_double_complex*>ds,
            <const rocblas_double_complex*>dl, <const rocblas_double_complex*>d,
            <const rocblas_double_complex*>du, <const rocblas_double_complex*>dw,
            <const rocblas_double_complex*>x, batchCount, &pBufferSizeInBytes)
    check_status(status)
...
cpdef sgpsvInterleavedBatch(intptr_t handle, int algo, int m, size_t ds,
    ...
    with nogil:
        status = cusparseSgpsvInterleavedBatch(
            <hipsparseHandle_t>handle, algo, m, <float*>ds, <float*>dl,
...
cpdef dgpsvInterleavedBatch(intptr_t handle, int algo, int m, size_t ds,
    ...
    with nogil:
        status = cusparseDgpsvInterleavedBatch(
            <hipsparseHandle_t>handle, algo, m, <double*>ds, <double*>dl,
...
cpdef cgpsvInterleavedBatch(intptr_t handle, int algo, int m, size_t ds,
    ...
    with nogil:
        status = cusparseCgpsvInterleavedBatch(
            <hipsparseHandle_t>handle, algo, m, <rocblas_float_complex*>ds, <rocblas_float_complex*>dl,
            <rocblas_float_complex*>d, <rocblas_float_complex*>du, <rocblas_float_complex*>dw, <rocblas_float_complex*>x,
            batchCount, <void*>pBuffer)
    check_status(status)
...
cpdef zgpsvInterleavedBatch(intptr_t handle, int algo, int m, size_t ds,
    ...
    with nogil:
        status = cusparseZgpsvInterleavedBatch(
            <hipsparseHandle_t>handle, algo, m, <rocblas_double_complex*>ds,
            <rocblas_double_complex*>dl, <rocblas_double_complex*>d, <rocblas_double_complex*>du,
            <rocblas_double_complex*>dw, <rocblas_double_complex*>x, batchCount,
            <void*>pBuffer)
    check_status(status)
...
cpdef size_t createCoo(int64_t rows, int64_t cols, int64_t nnz,
    ...
    status = hipsparseCreateCoo(&desc, rows, cols, nnz, <void*>cooRowInd,
                               <void*>cooColInd, <void*>cooValues,
...
cpdef size_t createCsr(int64_t rows, int64_t cols, int64_t nnz,
                       ...
                       DataType valueType):
    cdef SpMatDescr desc
    status = hipsparseCreateCsr(&desc, rows, cols, nnz,
...
cpdef destroySpMat(size_t desc):
    status = hipsparseDestroySpMat(<SpMatDescr>desc)
    check_status(status)
...
cpdef csrSetPointers(size_t desc, size_t csrRowOffsets, size_t csrColInd,
                     size_t csrValues):
    status = hipsparseCsrSetPointers(<SpMatDescr>desc, <void*>csrRowOffsets,
                                    <void*>csrColInd, <void*>csrValues)
    check_status(status)
...
cpdef spMatGetSize(size_t desc, size_t rows, size_t cols, size_t nnz):
    status = hipsparseSpMatGetSize(<SpMatDescr>desc, <int64_t*>rows,
                                  <int64_t*>cols, <int64_t*>nnz)
    check_status(status)
...
cpdef size_t createDnVec(int64_t size, intptr_t values,
    ...
    status = hipsparseCreateDnVec(&desc, size, <void*>values, valueType)
    check_status(status)
    return <size_t>desc

cpdef destroyDnVec(size_t desc):
    status = hipsparseDestroyDnVec(<DnVecDescr>desc)
    check_status(status)
...
cpdef size_t createDnMat(int64_t rows, int64_t cols, int64_t ld,
    ...
    status = hipsparseCreateDnMat(&desc, rows, cols, ld, <void*>values,
                                 valueType, order)
    check_status(status)
    return <size_t>desc

cpdef destroyDnMat(size_t desc):
    status = hipsparseDestroyDnMat(<DnMatDescr>desc)
    check_status(status)
...
cpdef dnMatSetStridedBatch(size_t desc, int batchCount, int64_t batchStride):
    status = hipsparseDnMatSetStridedBatch(<DnMatDescr>desc, batchCount,
                                          batchStride)
    check_status(status)
...
cpdef size_t spMV_bufferSize(intptr_t handle, Operation opA, intptr_t alpha,
    ...
    cdef size_t bufferSize
    status = hipsparseSpMV_bufferSize(<Handle>handle, opA, <void*>alpha,
                                     <SpMatDescr>matA, <DnVecDescr>vecX,
                                     <void*>beta, <DnVecDescr>vecY,
...
cpdef spMV(intptr_t handle, Operation opA, intptr_t alpha, size_t matA,
    ...
    _setStream(handle)
    status = hipsparseSpMV(<Handle>handle, opA, <void*>alpha, <SpMatDescr>matA,
...
cpdef size_t spMM_bufferSize(intptr_t handle, Operation opA, Operation opB,
                             ...
                             SpMMAlg alg):
    cdef size_t bufferSize
    status = hipsparseSpMM_bufferSize(<Handle>handle, opA, opB, <void*>alpha,
                                     <SpMatDescr>matA, <DnMatDescr>matB,
...
cpdef spMM(intptr_t handle, Operation opA, Operation opB, intptr_t alpha,
    ...
    _setStream(handle)
    status = hipsparseSpMM(<Handle>handle, opA, opB, <void*>alpha,
...
cpdef size_t spGEMM_createDescr():
    ...
    status = hipsparseSpGEMM_createDescr(&descr)
    check_status(status)
    return <size_t>descr

cpdef spGEMM_destroyDescr(size_t descr):
    status = hipsparseSpGEMM_destroyDescr(<SpGEMMDescr>descr)
    check_status(status)
