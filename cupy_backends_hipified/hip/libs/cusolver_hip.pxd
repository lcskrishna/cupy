...
cdef extern from *:
    ...
    ctypedef void* LibraryPropertyType 'hipLibraryPropertyType_t'

    ctypedef void* Handle 'hipsolverDnHandle_t'
    ctypedef void* SpHandle 'cusolverSpHandle_t'

    ctypedef void* Params 'hipsolverDnParams_t'

    ctypedef int Operation 'rocblas_operation'
    ctypedef int SideMode 'rocblas_side'
    ctypedef int FillMode 'rocblas_fill'

    ctypedef int EigType 'cusolverEigType_t'
    ctypedef int EigMode 'hipsolverEigMode_t'

    ctypedef void* MatDescr 'hipsparseMatDescr_t'

    ctypedef void* rocblas_float_complex 'rocblas_float_complex'
    ctypedef void* rocblas_double_complex 'rocblas_double_complex'

    ctypedef void* GesvdjInfo 'hipsolverGesvdjInfo_t'
    ctypedef void* SyevjInfo 'hipsolverSyevjInfo_t'
...
cpdef enum:
    ...
    HIPSOLVER_EIG_MODE_NOVECTOR = 0
    HIPSOLVER_EIG_MODE_VECTOR = 1
