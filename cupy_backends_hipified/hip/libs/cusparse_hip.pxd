...
cdef extern from *:
    ...
    ctypedef int Status 'hipsparseStatus_t'

    ctypedef void* Handle 'hipsparseHandle_t'

    ctypedef void* MatDescr 'hipsparseMatDescr_t'

    ctypedef int Direction 'hipsparseDirection_t'

    ctypedef int MatrixType 'cusparseMatrixType_t'
    ctypedef int FillMode 'hipsparseFillMode_t'
    ctypedef int DiagType 'hipsparseDiagType_t'

    ctypedef int Operation 'hipsparseOperation_t'
    ...
    ctypedef int hipsparseStatus_t
    ctypedef int hipsparseDirection_t
    ctypedef int hipsparseSolvePolicy_t

    ctypedef int IndexType 'hipsparseIndexType_t'
    ctypedef int Format 'cusparseFormat_t'
    ctypedef int Order 'cusparseOrder_t'
    ctypedef int SpMVAlg 'hipsparseSpMVAlg_t'
    ctypedef int SpSMAlg 'cusparseSpSMAlg_t'
    ctypedef int SpMMAlg 'hipsparseSpMMAlg_t'
    ...
    ctypedef void* DnVecDescr 'hipsparseDnVecDescr_t'
    ctypedef void* SpMatDescr 'hipsparseSpMatDescr_t'
    ctypedef void* DnMatDescr 'hipsparseDnMatDescr_t'
    ctypedef void* SpSMDescr 'cusparseSpSMDescr_t'
    ctypedef void* SpGEMMDescr 'hipsparseSpGEMMDescr_t'
    ...
    ctypedef void* hipsparseSpGEMMDescr_t
...
cpdef enum:
    ...
    HIPSPARSE_ORDER_COLUMN = 1  # Column-Major Order - Matrix memory layout
    ...
    HIPSPARSE_COOMM_ALG1 = 1  # non-deterministc results
    HIPSPARSE_COOMM_ALG2 = 2  # deterministic results
    HIPSPARSE_COOMM_ALG3 = 3  # non-deterministc results, for large matrices
    HIPSPARSE_CSRMM_ALG1 = 4

    CUSPARSE_INDEX_16U = 1  # 16-bit unsigned integer
    HIPSPARSE_INDEX_32I = 2  # 32-bit signed integer
    HIPSPARSE_INDEX_64I = 3  # 64-bit signed integer
